...
import { X, ChevronRight, Info, Heart, Star, ShoppingCart, Clock, User, BookOpen } from 'lucide-react';
...
const CBDLayout = () => {
  ...
  const topCategories = [
    { 
      ...
      image: "https://images.unsplash.com/photo-1582736704606-860ddb5c3320?w=300&h=200&fit=crop",
      colorFrom: "#3b82f6", 
      colorTo: "#1e40af" 
    },
    { 
  ...
  const articles = [
    {
      ...
      description: "CBD is a cannabinoid substance in the cannabis plant along with THC. Both cannabinoids have therapeutic properties, but research is still ongoing to understand their full potential.",
    ...
    },
    {
      ...
      description: "There are three types of CBD that come in many different forms and products. Here's what you need to know about full-spectrum, broad-spectrum, and isolate CBD products.",
      image: "https://images.unsplash.com/photo-1605028429441-b0d2cb6d3b57?w=400&h=300&fit=crop",
      category: "Guide",
      readTime: "3 min read",
      author: "Michael Chen"
    },
    {
      ...
      description: "Cannabidiol, or CBD, is a chemical compound in cannabis with a variety of uses. Here are 6 potential health benefits backed by scientific research.",
      image: "https://images.unsplash.com/photo-1582736704606-860ddb5c3320?w=400&h=300&fit=crop",
      category: "Health",
      readTime: "7 min read",
    ...
    },
    {
      ...
      description: "New to CBD? Figuring out your most effective dose usually takes some trial and error. Here's a beginner's guide to finding your optimal CBD dosage.",
    ...
    },
    {
      ...
      description: "Find out what the research says about CBD oil and anxiety. Also get the facts on how it might help with stress management and relaxation.",
    ...
    },
    {
      ...
      description: "Cannabidiol (CBD) oil, made from cannabis, is sometimes used for chronic pain. We'll explore what current research tells us about its effectiveness.",
  ...
  const popupContent = {
    1: {
      ...
      content: "Discover our top-rated CBD gummies for relaxation and wellness. Made with premium hemp extract and natural flavors for the perfect daily dose.",
      features: ["Third-party lab tested", "Full spectrum CBD", "Organic ingredients", "Vegan & gluten-free"],
      price: "$29.99",
      rating: 4.8,
      reviews: 1247
    },
    2: {
      ...
      content: "Specially formulated CBD gummies designed to help manage daily stress and promote calm feelings throughout your day.",
      features: ["25mg CBD per gummy", "L-theanine added", "Fast-acting formula", "Non-drowsy formula"],
      price: "$34.99",
      rating: 4.9,
      reviews: 892
    },
    3: {
      ...
      content: "High-quality CBD oil tinctures for precise dosing and maximum bioavailability. Perfect for those who prefer liquid CBD.",
      features: ["Multiple strengths available", "MCT oil base", "Easy dropper bottle", "Natural mint flavor"],
      price: "$49.99",
      rating: 4.7,
      reviews: 2156
    },
    4: {
      ...
      content: "Targeted relief with our CBD-infused creams and balms for localized comfort and skin nourishment.",
      features: ["1000mg CBD per jar", "Cooling menthol", "Fast absorption", "No greasy residue"],
      price: "$39.99",
      rating: 4.6,
      reviews: 743
    },
    5: {
      ...
      content: "Powerful CBD gummies enhanced with natural pain-fighting ingredients for targeted comfort support.",
      features: ["Extra strength formula", "Turmeric & ginger", "Long-lasting relief", "Delicious berry flavor"],
      price: "$44.99",
      rating: 4.8,
      reviews: 1089
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-100 via-purple-50 to-pink-100 py-12 sm:py-16 md:py-20">
        ...
        <div className={`relative max-w-6xl mx-auto px-4 sm:px-6 text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 max-w-2xl mx-auto px-4">
            Everything you need to know about CBD types, safety, efficacy, and products
          </p>
        </div>
      </div>
          ...
          {topCategories.map((category, index) => (
            <div
              ...
              className={`group relative overflow-hidden rounded-2xl cursor-pointer transform transition-all duration-700 hover:scale-105 hover:shadow-2xl ${
                hoveredCard === category.id ? 'shadow-2xl scale-105' : 'shadow-lg'
              }`}
              style={{
            ...
            >
              ...
              <div className="relative z-10 p-4 sm:p-6">
                ...
                <div className={`mt-3 sm:mt-4 flex items-center justify-between transform transition-all duration-500 ${hoveredCard === category.id ? 'translate-y-0 opacity-100' : 'translate-y-2 opacity-0'}`}>
                  <span className="text-white/80 text-xs sm:text-sm">Learn More</span>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {articles.map((article, index) => (
            <div
              key={article.id}
              className={`group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-700 border border-gray-100 ${hoveredArticle === article.id ? 'ring-2 ring-blue-200' : ''}`}
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="flex-1 p-4 sm:p-6">
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <button className="flex items-center text-blue-600 font-semibold hover:text-purple-600 transition-colors duration-300 text-sm">
                  ...
                  <div className="flex items-center flex-wrap">
                    <div className="flex items-center mr-3 mb-1">
                      {[...Array(5)].map((_, i) => (
                        <Star 
                          key={i} 
                          className={`${i < Math.floor(popupContent[selectedPopup]?.rating) ? 'text-yellow-300 fill-current' : 'text-gray-300'}`} 
                          size={14} 
                        />
                      ))}
                    </div>
                    <span className="text-sm">
                      {popupContent[selectedPopup]?.rating}/5 ({popupContent[selectedPopup]?.reviews} reviews)
                    </span>
                  </div>
                </div>
                <button
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {popupContent[selectedPopup]?.features.map((feature, index) => (
              ...
              <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-4 rounded-xl">
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div>
                    ...
                    <div className="text-xs sm:text-sm text-gray-500">Free shipping on orders $50+</div>
                  </div>
